...
export function MenuItem({
  ...
  return (
    <BaseMenu.Item
      disabled={disabled}
      onClick={onSelect}
      className={cx(itemClass, danger && "text-danger")}
    >
      {children}
    </BaseMenu.Item>
  );
...
const itemClass =
  "flex min-h-8 cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 outline-none data-[highlighted]:bg-hover data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0";
