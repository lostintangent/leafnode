...
// One immutable JSON document plus its transient editor interactions. Local
// mutations publish serialized source once; external loads re-baseline silently.
...
function samePointers(a: ReadonlySet<string>, b: ReadonlySet<string>): boolean {
